...
export const createTicket = PromiseWrapper(
  async (
    ...
    if (!_id) {
      ...
      let meraDoctor = doctorDate.toISOString();
      let doctorYear = doctorDate.getFullYear();
      let doctorMonth = doctorDate.getMonth();
      let doctorDay = doctorDate.getDay();
      console.log(doctorDate.toISOString(), "hello");
      console.log(meraDoctor.split("T")[0], "newdatatbtbeb");
      console.log(doctorMonth, "monthsss ");
      console.log(doctorDay, "ayyyyy");
